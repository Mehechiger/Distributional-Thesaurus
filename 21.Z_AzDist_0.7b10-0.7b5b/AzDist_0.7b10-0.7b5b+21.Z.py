    ...
    def simsCal(self):
        def CalCos():
            ...
            for cat in self.cats:
                ...
                print("Converting into Pandas DataFrame format... 1/4", end="\r")
                ...
                # convert into scipy sparse matrix for better performance
                wVecs = sp.csc_matrix(wVecs)
                print("Converting into Pandas DataFrame format... DONE")
